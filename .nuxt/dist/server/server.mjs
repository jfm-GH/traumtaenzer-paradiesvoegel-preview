...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-Cgxhv3jL.js").then((m) => m.default || m)
  }
];
...
const LazyIconDark = defineAsyncComponent(() => import("./_nuxt/IconDark-G9IBksHL.js").then((r) => r["default"] || r.default || r));
const LazyIconLight = defineAsyncComponent(() => import("./_nuxt/IconLight-BoFoFb7b.js").then((r) => r["default"] || r.default || r));
const LazyIconSepia = defineAsyncComponent(() => import("./_nuxt/IconSepia-CLDqcRXD.js").then((r) => r["default"] || r.default || r));
const LazyIconSystem = defineAsyncComponent(() => import("./_nuxt/IconSystem-CgwluYk8.js").then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-N1UOZoAo.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  "one-page-app": () => import("./_nuxt/OnePageApp-BbQzMNUK.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CrGyiWkZ.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-D1je-fvG.js").then((r) => r.default || r));
