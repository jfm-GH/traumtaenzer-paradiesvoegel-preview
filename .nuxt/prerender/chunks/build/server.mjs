...
import { getContext } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/h3/dist/index.mjs';
import { CapoPlugin, getActiveHead } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/radix3/dist/index.mjs';
import { defuFn, createDefu, defu } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/ufo/dist/index.mjs';
import { klona } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/klona/dist/index.mjs';
import { extendTailwindMerge } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
import { _api, disableCache, addAPIProvider } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/@iconify/vue/dist/iconify.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/vue/server-renderer/index.mjs';
...
import 'file:///website-public/traumtaenzer-paradiesvoegel-public/node_modules/ohash/dist/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-Cgxhv3jL.mjs').then((m) => m.default || m)
  }
];
...
const LazyIconDark = defineAsyncComponent(() => import('./IconDark-G9IBksHL.mjs').then((r) => r["default"] || r.default || r));
const LazyIconLight = defineAsyncComponent(() => import('./IconLight-BoFoFb7b.mjs').then((r) => r["default"] || r.default || r));
const LazyIconSepia = defineAsyncComponent(() => import('./IconSepia-CLDqcRXD.mjs').then((r) => r["default"] || r.default || r));
const LazyIconSystem = defineAsyncComponent(() => import('./IconSystem-CgwluYk8.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./index-N1UOZoAo.mjs').then((r) => r["default"] || r.default || r));
const lazyGlobalComponents = [
  ["IconDark", LazyIconDark],
  ["IconLight", LazyIconLight],
  ["IconSepia", LazyIconSepia],
  ["IconSystem", LazyIconSystem],
  ["Icon", LazyIcon]
];
...
const layouts = {
  "one-page-app": () => import('./OnePageApp-BbQzMNUK.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CrGyiWkZ.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-D1je-fvG.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useAppConfig as a, appConfig as b, useState as c, useRouter as d, entry$1 as default, navigateTo as e, useRuntimeConfig as f, get as g, useNuxtApp as h, asyncDataDefaults as i, createError as j, mergeConfig as m, nuxtLinkDefaults as n, omit as o, resolveRouteObject as r, useHead as u };
